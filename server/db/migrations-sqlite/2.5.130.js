exports.up = async knex => {
  const teamRules = [{ id: 'team', roles: ['read:pages', 'write:pages', 'read:source', 'read:history', 'read:assets', 'write:assets'], match: 'START', deny: false, path: 'team/', locales: [] }, { id: 'public', roles: ['read:pages', 'read:source', 'read:assets'], match: 'START', deny: false, path: 'public/', locales: [] }]
